...
declare type ResolvedDataDependencyStatusType = 'deferred' | 'success' | 'error';
declare type BaseResolvedDataDependencyResult = {
    type: ResolvedDataDependencyStatusType;
};
declare type ResolvedDataDependencyResultSuccess<T> = BaseResolvedDataDependencyResult & {
    type: 'success';
    data: T;
};
declare type ResolvedDataDependencyResultError = BaseResolvedDataDependencyResult & {
    type: 'error';
    error: string;
};
declare type ResolvedDataDependencyResultDeferred = BaseResolvedDataDependencyResult & {
    type: 'deferred';
};
declare type ResolvedDataDependencyResult<T> = ResolvedDataDependencyResultSuccess<T> | ResolvedDataDependencyResultError | ResolvedDataDependencyResultDeferred;
export declare type ResolvedDataDependencies = {
    availableTranslations?: ResolvedDataDependencyResult<AvailableTranslations> | null;
};
